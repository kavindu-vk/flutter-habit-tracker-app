...
import 'package:habit_app/services/list.dart';
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            ...
            TextEditingController habitDescriptionController =
                TextEditingController(text: "abit Description");
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(20, 250, 0, 20),
                    child: Align(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            "You have ${habitList.length - counter} habit left for today",
                            style: const TextStyle(
                              fontSize: 15,
                  ...
                  SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        backgroundColor: Color.fromARGB(255, 170, 227, 250),
